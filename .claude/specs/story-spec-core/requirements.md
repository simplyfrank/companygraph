...
- **PWA shell + catalog** (`pwa/src/views/index.tsx` `renderView`, `pwa/src/components/{Card,DataTable,Modal,SidePanel}.tsx`, `tokens.css`, `scripts/design-conformance.ts`).
