...
| AC-11 | TypeScript transpiles cleanly; bundle does not regress past 300 KB gzipped (NFR-01, NFR-05) | n/a (build) | `bun run typecheck` exits 0; `bun run bundle-check` (process-explorer-ui AC-22) asserts main chunk ≤ 300 KB gzipped |
