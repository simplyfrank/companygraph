...
describe("Ontology · Catalog · Validation · DUPLICATE LABEL NAME", () => {
  beforeEach(() => {
    cleanup();
    vi.restoreAllMocks();
  });

  test("(1) Creating existing label name", async () => {
        // No mock setup required for this scenario
        const route = { surface: "ontology", tab: "catalog", params: { "name": "Domain", "description": "Test", "usageExample": "Test" } };
    await act(async () => {
