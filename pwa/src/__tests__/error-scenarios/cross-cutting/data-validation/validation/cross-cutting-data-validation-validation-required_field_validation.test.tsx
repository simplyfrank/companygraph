...
describe("Explorer · Domains · Validation · REQUIRED FIELD VALIDATION", () => {
  beforeEach(() => {
    cleanup();
    vi.restoreAllMocks();
  });

  test("(1) Empty required string fields", async () => {
        // No mock setup required for this scenario
        const route = { surface: "explorer", tab: "domains", params: { "name": "", "description": "" } };
    await act(async () => {
