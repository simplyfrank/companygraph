...
describe("Explorer · Domains · Validation · JSON SCHEMA VALIDATION", () => {
  beforeEach(() => {
    cleanup();
    vi.restoreAllMocks();
  });

  test("(1) Invalid JSON structure", async () => {
        // No mock setup required for this scenario
        const route = { surface: "explorer", tab: "domains", params: { "schema": "{ invalid }" } };
    await act(async () => {
